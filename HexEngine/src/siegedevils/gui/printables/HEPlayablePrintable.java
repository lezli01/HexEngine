...
import lezli.hex.engine.moddable.playables.HEPlayable;
...
public class HEPlayablePrintable< T extends HEPlayable > implements Printable{

	private T mPlayable;
	
	public HEPlayablePrintable( T xPlayable ){
